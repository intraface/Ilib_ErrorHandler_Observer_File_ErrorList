...
<?php else: ?>
    ...
    <?php if(isset($items) && is_array($items)): ?>
        <?php foreach($items AS $item): ?>
            ...
            <?php if($path_to_translation != '' && preg_match("/^Translation2: Missing translation for \"([a-zA-ZæøåÆØÅ _-]+)\"/", $item['title'], $params)): ?>
                <a href="<?php e(url($path_to_translation, array('create', 'edit_id' => $params[1]))); ?>">Add translation</a>
            <?php endif; ?>
            </p>
        <?php endforeach; ?>
    <?php endif; ?>
